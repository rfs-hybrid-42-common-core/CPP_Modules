...
/*   Updated: 2026/08/15 14:51:58 by maaugust         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @fn int main(void)
 * @brief The main execution point for testing deep copies and memory 
 * management.
 * @details Tests the allocation and deletion of an array of Animal pointers to 
 * verify virtual destruction. Also performs deep copy tests using the Orthodox 
 * Canonical Form to ensure Brain objects are properly cloned and not shared.
